...
import sphy.images.storage.StorageFileNotFoundException;
...
public class ImageController {
    ...
    public void handleFileUpload(@PathVariable String weapon, @PathVariable String category, @PathVariable String subject,@RequestParam("file") MultipartFile file){
